...
Graph.prototype.addEdge = function(fromNode, toNode) {
  api_key_geocoding(this.list[fromNode]['address'], this.list[fromNode]['address'], (response) => {
    this.vertices[fromNode+'-'+toNode] = response;
    console.log(this.vertices[fromNode+'-'+toNode]);
  });
